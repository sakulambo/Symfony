...
EOHTML
        ...
        $template = $twig->loadTemplate('list_task.html.twig');
        try {
            $template->render(array());

            $this->fail();
        } catch (Twig_Error_Runtime $e) {
            $this->assertEquals('Variable "foo" does not exist in "list_task.html.twig" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('list_task.html.twig', $e->getSourceContext()->getName());
        }
    }
...
EOHTML
        ...
        try {
            ...
            $this->assertEquals('An exception has been thrown during the rendering of a template ("Runtime error...") in "list_task.html.twig" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('list_task.html.twig', $e->getSourceContext()->getName());
        }
    }
    ...
    public function testTwigExceptionGuessWithMissingVarAndFilesystemLoader()
    {
        ...
        try {
            ...
            $this->assertEquals(strtr(dirname(__FILE__).'/Fixtures/errors/list_task.html.twig', '/', DIRECTORY_SEPARATOR), $e->getFile());
        }
    }
