...
class Twig_Tests_Loader_FilesystemTest extends \PHPUnit\Framework\TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/list_task.html.twig', $loader->getSourceContext('errors/list_task.html.twig')->getName());
        $this->assertEquals(realpath($path.'/errors/list_task.html.twig'), realpath($loader->getSourceContext('errors/list_task.html.twig')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('list_task.html.twig')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/list_task.html.twig')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/list_task.html.twig')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for list_task.html.twig in the named namespace
        $namedSource = $loader->getSourceContext('@named/list_task.html.twig')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get list_task.html.twig from the main namespace
