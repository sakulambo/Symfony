...
class Twig_Tests_Loader_ChainTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetSourceContext()
    {
        ...
        $loader = new Twig_Loader_Chain(array(
            new Twig_Loader_Array(array('foo' => 'bar')),
            new Twig_Loader_Array(array('errors/list_task.html.twig' => 'baz')),
        ...
        $this->assertSame('', $loader->getSourceContext('errors/list_task.html.twig')->getPath());
        $this->assertEquals('baz', $loader->getSourceContext('errors/list_task.html.twig')->getCode());
