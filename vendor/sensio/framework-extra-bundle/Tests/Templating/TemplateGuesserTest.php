...
class TemplateGuesserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('@Foo/foo/list_task.html.twig.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals('my_admin/out_of_bundle/list_task.html.twig.twig', (string) $templateReference);
    }
